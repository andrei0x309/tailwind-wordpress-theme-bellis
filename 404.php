...
$style = '<style>'.
file_get_contents(__DIR__.vite_assets('/dev-assets/scss/404.scss'))
.'</style>';
...
<div class="main flex w-full mt-6 mb-6 justify-center">
    ...
    <main class="flex flex-col content bg-white w-full sm:w-full md:w-7/12 lg:w-7/12 xl:w-7/12 p-8 dark:bg-dark-bg text-dark-text">
...
if ($my_posts->have_posts()) { ?>
   ...
   <!-- Card -->
        ...
        <div style="padding-top: 56.25%;" class="w-full relative">
            <img style="top:0" class="w-full object-cover object-center absolute max-h-40" width="400" height="225" loading="lazy" src="<?php echo theme_resize_img_src(get_the_post_thumbnail_url($post->ID), 400); ?>" alt="<?php echo $alt; ?>">
        </div>
        <!-- Card Content -->
